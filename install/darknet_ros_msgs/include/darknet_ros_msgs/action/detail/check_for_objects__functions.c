  ...
  darknet_ros_msgs__action__CheckForObjects_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_Goal * data =
      (darknet_ros_msgs__action__CheckForObjects_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_Result * data =
      (darknet_ros_msgs__action__CheckForObjects_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_Feedback * data =
      (darknet_ros_msgs__action__CheckForObjects_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_SendGoal_Request * data =
      (darknet_ros_msgs__action__CheckForObjects_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_SendGoal_Response * data =
      (darknet_ros_msgs__action__CheckForObjects_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_GetResult_Request * data =
      (darknet_ros_msgs__action__CheckForObjects_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_GetResult_Response * data =
      (darknet_ros_msgs__action__CheckForObjects_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  darknet_ros_msgs__action__CheckForObjects_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    darknet_ros_msgs__action__CheckForObjects_FeedbackMessage * data =
      (darknet_ros_msgs__action__CheckForObjects_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!darknet_ros_msgs__action__CheckForObjects_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          darknet_ros_msgs__action__CheckForObjects_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
